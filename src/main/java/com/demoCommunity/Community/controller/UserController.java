...
import com.demoCommunity.Community.service.FollowService;
...
//    public String updatePassword(Model model, String x_password, String y_password) {
//        if(StringUtils.isBlank(x_password)){
//            throw new IllegalArgumentException("密码不能为空！");
//        }
//        User user = hostHolder.getUser();
//        String oldPassword=user.getPassword();
//        if(x_password.equals(oldPassword)){
//            userService.updatePassword(user.getId(),y_password);
//        }
//        return "/index";
//    }
